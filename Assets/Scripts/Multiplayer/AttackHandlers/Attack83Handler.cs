...
public class Attack83Handler
{
    ...
    {
        yield return showDialog($"{attacker.cardName} uses Katana");
        yield return animations.PlayKatanaAnimation(attacker.transform, defender.transform);
        ...
        yield return showDialog($"{attacker.cardName} slashes with katana");
