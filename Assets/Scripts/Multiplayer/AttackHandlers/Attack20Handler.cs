...
public class Attack20Handler
{
    ...
    {
        yield return showDialog($"{attacker.cardName} uses Pike");
        yield return animations.PlayPikeAnimation(attacker.transform, defender.transform);
        ...
        yield return showDialog($"{attacker.cardName} strikes with pike");
