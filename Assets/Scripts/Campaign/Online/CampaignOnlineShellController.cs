...
public class CampaignOnlineShellController : MonoBehaviour
{
    ...
    {
        LogVerboseWarning(
            $"[CampaignOnlineShellController] Card XP feedback: applied={progression?.applied == true}, pending={progression?.pending == true}, "
        ...
        {
            LogVerboseWarning(
                $"[CampaignOnlineShellController] Card XP feedback skipped: reason={skipReason}, "
        ...
        LogVerboseWarning(
            $"[CampaignOnlineShellController] Card XP feedback played: card={progression.playerCardId}, xp={progression.xpGained}, "
