public static class TutorialConstants
{
    ...
    public const string OpenMarketplace = "open_marketplace";
    ...
    public const string ConfirmAttack = "confirm_attack";
    public const string CompleteControls = "complete_controls";
}
