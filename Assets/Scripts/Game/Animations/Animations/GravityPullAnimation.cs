...
public class GravityPullAnimation : MonoBehaviour
{
    public Canvas canvas; // Referencia na váš Canvas

    public IEnumerator StartAnimation(Sprite sprite, AudioClip sound, Transform startPoint, Transform endPoint, Vector2 imageSize, float duration, float initialRotation = 0f, float finalRotation = 0f, bool rotateTowardsTarget = true, float moveDurationRatio = 1f)
    {
