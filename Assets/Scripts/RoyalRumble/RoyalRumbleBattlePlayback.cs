...
public class RoyalRumbleBattlePlayback : MonoBehaviour
{
        ...
        string playerCardId)
    {
        ...
        {
            Debug.LogError($"[RoyalRumbleBattlePlayback] TimelineV2 unavailable. RR legacy playback is disabled. Error: {timelineError}");
        ...
        {
            Debug.LogWarning(
                $"[RoyalRumbleBattlePlayback] Playing TimelineV2: steps={timelineSteps.Count}, " +
