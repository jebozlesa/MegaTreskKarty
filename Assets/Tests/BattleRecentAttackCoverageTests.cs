...
public class BattleRecentAttackCoverageTests
{
    ...
    public void SharedEffectPlayback_CoversElectricityTetherBlockadeDepressionAndOngoingActions()
    {
        ...
        string timelinePlayback =
            ReadProjectFile("Assets", "Scripts", "Multiplayer", "BattleTimeline", "BattleTimelinePlayback.cs");
        StringAssert.Contains("case 8:", timelinePlayback);
        StringAssert.Contains("PlayElectricityAnimation(card.transform)", timelinePlayback);
        StringAssert.Contains("ShowDialog(context, $\"{card.cardName} cannot move\")", timelinePlayback);
        StringAssert.Contains("case 9:", timelinePlayback);
        StringAssert.Contains("PlayTetherAnimation(card.transform)", timelinePlayback);
        StringAssert.Contains("ShowDialog(context, $\"{card.cardName} is locked\")", timelinePlayback);
        StringAssert.Contains("case 12:", timelinePlayback);
        StringAssert.Contains("PlayBlocadeWaitAnimation(card.transform)", timelinePlayback);
        StringAssert.Contains("ShowDialog(context, \"The blockade holds strong\")", timelinePlayback);
        StringAssert.Contains("!string.Equals(step.Source, \"attack\", StringComparison.OrdinalIgnoreCase)", timelinePlayback);
        StringAssert.Contains("doubleEnvelopment", timelinePlayback);
        StringAssert.Contains("PlayDoubleEnvelopmentWaitAnimation(actor.transform)", timelinePlayback);
        StringAssert.Contains("PlayDoubleEnvelopAttackAnimation(target.transform)", timelinePlayback);
        StringAssert.Contains("artInspiration", timelinePlayback);
        StringAssert.Contains("PlayArtInspirationWaitAnimation(actor.transform)", timelinePlayback);
        StringAssert.Contains("PlayArtInspirationEndAttackAnimation(actor.transform, target.transform)", timelinePlayback);
        StringAssert.Contains("autoportrait", timelinePlayback);
        StringAssert.Contains("PlayAutoportraitAnimation(actor.transform)", timelinePlayback);
        StringAssert.Contains("PlayAutoportraitFinishAnimation(actor.transform)", timelinePlayback);
        StringAssert.Contains("buffaloHorns", timelinePlayback);
        StringAssert.Contains("PlayBuffaloHornsContinueAnimation(actor.transform)", timelinePlayback);
        StringAssert.Contains("PlayBuffaloHornsEndAnimation(", timelinePlayback);
        StringAssert.Contains("flintlockPistol", timelinePlayback);
        StringAssert.Contains("PlayFlintlockPistolLoadingAnimation(actor.transform)", timelinePlayback);
        StringAssert.Contains("PlayFlintlockPistolShotAnimation(", timelinePlayback);
        StringAssert.Contains("case BattleStepType.SatelliteTick:", timelinePlayback);
        StringAssert.Contains("PlaySatelliteAnimation(actor.transform)", timelinePlayback);
        StringAssert.Contains("!string.IsNullOrEmpty(step.Note)", timelinePlayback);
        StringAssert.Contains("ShowDialog(context, step.Note)", timelinePlayback);
